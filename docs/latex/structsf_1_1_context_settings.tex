...
{\bfseries Special Note for OS X\+:} Apple only supports choosing between either a legacy context (Open\+GL 2.\+1) or a core context (Open\+GL version depends on the operating system version but is at least 3.\+2). Compatibility contexts are not supported. Further information is available on the \href{https://developer.apple.com/opengl/capabilities/index.html}{\tt Open\+GL Capabilities Tables} page. OS X also currently does not support debug contexts.
...
\index{sf\+::\+Context\+Settings@{sf\+::\+Context\+Settings}!Attribute@{Attribute}}
\index{Attribute@{Attribute}!sf\+::\+Context\+Settings@{sf\+::\+Context\+Settings}}
...
\index{sf\+::\+Context\+Settings@{sf\+::\+Context\+Settings}!Context\+Settings@{Context\+Settings}}
\index{Context\+Settings@{Context\+Settings}!sf\+::\+Context\+Settings@{sf\+::\+Context\+Settings}}
\subsubsection{\texorpdfstring{Context\+Settings()}{ContextSettings()}}
