...
{\footnotesize\ttfamily const \hyperlink{classsf_1_1_glyph}{Glyph}\& sf\+::\+Font\+::get\+Glyph (\begin{DoxyParamCaption}\item[{Uint32}]{code\+Point,  }\item[{unsigned int}]{character\+Size,  }\item[{bool}]{bold,  }\item[{float}]{outline\+Thickness = {\ttfamily 0} }\end{DoxyParamCaption}) const}
